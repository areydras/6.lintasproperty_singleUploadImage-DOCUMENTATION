    ...
    <div>
        ...
        <section class="featured-properties-area section-padding-100-50">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-xl-4" v-for="(property, index) in properties.data" :key="index">
                        <div class="single-featured-property mb-50" v-if="index <= 5">
                            <!-- Property Thumbnail -->
                            <div class="property-thumb">
                                <img :src="'/image/properties/' + property.image" v-show="property.image">

                                <div class="tag">
                                    <span>For Sale</span>
                                </div>
                                <div class="list-price">
                                    <p>Rp. {{ property.price }}</p>
                                </div>
                            </div>
                            <!-- Property Content -->
                            <div class="property-content">
                                ...
                                <p>
                                    <span v-if="property.description.length > 200">{{ property.description.substring(0,150)+".." }}</span>
                ...
                <div class="row align-items-center h-100">
                    <div class="col-12">
                        <div class="cta-content text-center">
                            ...
                            <router-link to="/properties" class="btn south-btn mt-50 wow fadeInUp" data-wow-delay="500ms">Search</router-link>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="south-editor-area d-flex align-items-center">
            ...
            <div class="editor-content-area">
                ...
                <p class="wow fadeInUp" data-wow-delay="500ms">{{ owner.address }}</p>
                <div class="address wow fadeInUp" data-wow-delay="750ms">
                    <h6><img src="img/icons/phone-call.png" alt="">{{ owner.phone }}</h6>
                    <h6><img src="img/icons/envelope.png" alt="">{{ owner.email }}</h6>
                </div>
            ...
            <div class="editor-thumbnail">
                <img :src="'/image/profile/'+ owner.photo " alt="">
            </div>
        </section>
    </div>
</template>
...
<script>
    export default {
        ...
        methods : {
            getOwner(){
                axios.get('/api/owner', this.$parent.config).then((res) => {
                    this.owner = res.data
                    console.log(this.owner)
                })
            },
            getProperties(){
                axios.get('/api/property', this.$parent.config).then((res) => {
